      ...
      <Card className="p-6 bg-blue-50 border-blue-200">
        ...
        <div className="space-y-3 text-sm text-blue-800">
          <div className="flex items-start space-x-2">
            ...
            <p>Once confirmed by the doctor, you&apos;ll be able to join a secure video call for your consultation.</p>
          </div>
          <div className="flex items-start space-x-2">
            <svg className="w-4 h-4 mt-0.5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
            </svg>
            <p>Please test your camera and microphone beforehand and find a quiet, well-lit location.</p>
          </div>
          <div className="flex items-start space-x-2">
            <svg className="w-4 h-4 mt-0.5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
